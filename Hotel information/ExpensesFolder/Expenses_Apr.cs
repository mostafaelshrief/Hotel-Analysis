...
{
    public partial class Expenses_Apr : Form
    {
        public Expenses_Apr()
        {
            InitializeComponent();
        ...
        private void Expenses_Apr_Load(object sender, EventArgs e)
        {
            populate();
        }
        ...
        {
            Con.Open();
            String query = "select * from Expenses_AprTbl";
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                Con.Open();
                String query = "insert into Expenses_AprTbl values(N'" + TypeCB.SelectedItem.ToString() + "','" + PriceTb.Text + "','" + CommentTB.Text + "','" + label12.Text + "')";
                SqlCommand cmd = new SqlCommand("INSERT INTO Expenses_AprTbl (Type,Price,Comment) VALUES " +
        ...
        private void button3_Click(object sender, EventArgs e)
        {
            ...
            {
                Con.Open();
                String query = "delete from Expenses_AprTbl where Type=N'" + TypeCB.SelectedItem.ToString() + "';";
                SqlCommand cmd = new SqlCommand(query, Con);
                cmd.ExecuteNonQuery();
        ...
        {
            Con.Open();
            string query1 = "select * from Expenses_AprTbl where Type='" + TypeCB.SelectedItem.ToString() + "' ";
            SqlCommand cmd1 = new SqlCommand(query1, Con);
            DataTable dt = new DataTable();
            SqlDataAdapter sda = new SqlDataAdapter(cmd1);
            sda.Fill(dt);
            ...
            string query = "update Expenses_AprTbl set Price='" + STRUpdateprice + "',Comment='" + CommentTB.Text + "' where  Type='" + TypeCB.SelectedItem.ToString() + "';";
            SqlCommand cmd = new SqlCommand(query, Con);
            cmd1.ExecuteNonQuery();
            cmd.ExecuteNonQuery();
            MessageBox.Show("Data updateed successfully");
