...
{
    public partial class Expenses_Aug : Form
    {
        public Expenses_Aug()
        {
            InitializeComponent();
        ...
        private void Expenses_Aug_Load(object sender, EventArgs e)
        {
            populate();
        }
        ...
        {
            Con.Open();
            String query = "select * from Expenses_AugTbl";
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                Con.Open();
                String query = "insert into Expenses_AugTbl values(N'" + TypeCB.SelectedItem.ToString() + "','" + PriceTb.Text + "','" + CommentTB.Text + "','" + label12.Text + "')";
                SqlCommand cmd = new SqlCommand("INSERT INTO Expenses_AugTbl (Type,Price,Comment) VALUES " +
        ...
        private void button3_Click(object sender, EventArgs e)
        {
            ...
            {
                Con.Open();
                String query = "delete from Expenses_AugTbl where Type=N'" + TypeCB.SelectedItem.ToString() + "';";
                SqlCommand cmd = new SqlCommand(query, Con);
                cmd.ExecuteNonQuery();
        ...
        {
            Con.Open();
            string query1 = "select * from Expenses_AugTbl where Type='" + TypeCB.SelectedItem.ToString() + "' ";
            SqlCommand cmd1 = new SqlCommand(query1, Con);
            DataTable dt = new DataTable();
            SqlDataAdapter sda = new SqlDataAdapter(cmd1);
            sda.Fill(dt);
            ...
            string query = "update Expenses_AugTbl set Price='" + STRUpdateprice + "',Comment='" + CommentTB.Text + "' where  Type='" + TypeCB.SelectedItem.ToString() + "';";
            SqlCommand cmd = new SqlCommand(query, Con);
