...
{
    public partial class BackView_Sep : Form
    {
        public BackView_Sep()
        {
            InitializeComponent();
        ...
        private void BackView_Sep_Load(object sender, EventArgs e)
        {
            populate();
        }
        ...
        {
            Con.Open();
            String query = "select * from BackView_SepTbl";
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                Con.Open();
                String query = "insert into BackView_SepTbl values(N'" + RoomTb.Text + "','" + PriceTb.Text + "','" + DayTb.Text + "','" + PriceTotalLbl.Text + "','" + label12.Text + "')";
                SqlCommand cmd = new SqlCommand("INSERT INTO BackView_SepTbl (Room,Price,Type,Days,TotalPrice) VALUES " +
        ...
        private void button3_Click(object sender, EventArgs e)
        {
            ...
            {
                Con.Open();
                String query = "delete from BackView_SepTbl where Room=N'" + RoomTb.Text + "';";
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            ...
            Con.Open();
            string query1 = "select * from BackView_SepTbl where (Room=N'" + RoomTb.Text + "' AND Type='" + TypeCB.SelectedItem.ToString() + "')";
            SqlCommand cmd1 = new SqlCommand(query1, Con);
            DataTable dt = new DataTable();
            SqlDataAdapter sda = new SqlDataAdapter(cmd1);
            sda.Fill(dt);
            ...
            string query = "update BackView_SepTbl set Days='" + STRUPdatedays + "',TotalPrice='" + STRUpdatetotalprice + "' where (Room=N'" + RoomTb.Text + "' AND Type='" + TypeCB.SelectedItem.ToString() + "');";
            SqlCommand cmd = new SqlCommand(query, Con);
            cmd.ExecuteNonQuery();
            MessageBox.Show("Data updateed successfully");
            Con.Close();
