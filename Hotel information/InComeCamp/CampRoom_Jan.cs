...
{
    public partial class CampRoom_Jan : Form
    {
        public CampRoom_Jan()
        {
            InitializeComponent();
        ...
        {
            Con.Open();
            String query = "select * from CampTbl";
        ...
        private void button1_Click_1(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                SqlCommand cmd = new SqlCommand("INSERT INTO CampTbl (Room,Price,Type,Days,TotalPrice) VALUES " +
        ...
        private void CampRoom_Load(object sender, EventArgs e)
        {
            populate();
        }
        ...
        private void button3_Click_1(object sender, EventArgs e)
        {
            ...
            {
                Con.Open();
                String query = "delete from CampTbl where Room=N'" + RoomTb.Text + "';";
        ...
        private void button2_Click_1(object sender, EventArgs e)
        {
            ...
            Con.Open();
            string query1 = "select * from CampTbl where (Room=N'" + RoomTb.Text + "' AND Type='" + TypeCB.SelectedItem.ToString() + "')";
            SqlCommand cmd1 = new SqlCommand(query1, Con);
            DataTable dt = new DataTable();
            SqlDataAdapter sda = new SqlDataAdapter(cmd1);
            sda.Fill(dt);
            ...
            string query = "update CampTbl set Days='" + STRUPdatedays + "',TotalPrice='" + STRUpdatetotalprice + "' where (Room=N'" + RoomTb.Text + "' AND Type='" + TypeCB.SelectedItem.ToString() + "');";
            SqlCommand cmd = new SqlCommand(query, Con);
            cmd.ExecuteNonQuery();
