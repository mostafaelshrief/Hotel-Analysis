...
namespace Hotel_information.Mangers
{
    public partial class Mangers_Apr : Form
    {
        ...
        {
            Con.Open();
            string query1 = "select * from Manger_Apr where Name=N'" + textBox1.Text + "'";
            ...
            string query = "update Manger_Apr set commission='" + STRUpdateprice + "' where Name=N'" + textBox1.Text + "';";
            SqlCommand cmd = new SqlCommand(query, Con);
            cmd.ExecuteNonQuery();
