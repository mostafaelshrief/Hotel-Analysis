...
{
    public partial class Mangers_Aug : Form
    {
        public Mangers_Aug()
        {
            InitializeComponent();
        ...
        {
            Con.Open();
            string query1 = "select * from Manger_Aug where Name=N'" + textBox1.Text + "'";
            ...
            string query = "update Manger_Aug set commission='" + STRUpdateprice + "' where Name=N'" + textBox1.Text + "';";
        ...
        {
            Con.Open();
            string query = "select * from Manger_Aug";
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            {
                Con.Open();
                String query = "insert into Manger_Aug values(N'" + textBox1.Text + "','" + textBox2.Text + "')";
                SqlCommand cmd = new SqlCommand(query, Con);
                cmd.ExecuteNonQuery();
        ...
        private void Mangers_Aug_Load(object sender, EventArgs e)
        {
            populate();
        }
    }
