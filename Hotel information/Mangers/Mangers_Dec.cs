...
namespace Hotel_information.Mangers
{
    public partial class Mangers_Dec : Form
    {
        ...
        {
            Con.Open();
            string query1 = "select * from Manger_Dec where Name=N'" + textBox1.Text + "'";
            ...
            string query = "update Manger_Dec set commission='" + STRUpdateprice + "' where Name=N'" + textBox1.Text + "';";
