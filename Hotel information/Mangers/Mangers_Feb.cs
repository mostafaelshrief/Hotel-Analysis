...
{
    public partial class Mangers_Feb : Form
    {
        public Mangers_Feb()
        {
            InitializeComponent();
        ...
        {
            Con.Open();
            string query1 = "select * from Mangers_Feb where Name=N'" + textBox1.Text + "'";
            ...
            string query = "update Mangers_Feb set commission='" + STRUpdateprice + "' where Name=N'" + textBox1.Text + "';";
        ...
        {
            Con.Open();
            string query = "select * from Mangers_Feb";
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            {
                Con.Open();
                String query = "insert into Mangers_Feb values(N'" + textBox1.Text + "','" + textBox2.Text + "')";
                SqlCommand cmd = new SqlCommand(query, Con);
                cmd.ExecuteNonQuery();
        ...
        private void Mangers_Feb_Load(object sender, EventArgs e)
        {
            populate();
        }
    }
