...
{
    public partial class Mangers_Jan : Form
    {
        public Mangers_Jan()
        {
            InitializeComponent();
        ...
        {
            Con.Open();
            string query1 = "select * from Mangers_Jan where Name=N'" + textBox1.Text + "'";
            ...
            string query = "update Mangers_Jan set commission='" + STRUpdateprice + "' where Name=N'" + textBox1.Text + "';";
        ...
        {
            Con.Open();
            string query = "select * from Mangers_Jan";
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            {
                Con.Open();
                String query = "insert into Mangers_Jan values(N'" + textBox1.Text + "','" + textBox2.Text + "')";
                SqlCommand cmd = new SqlCommand(query, Con);
                cmd.ExecuteNonQuery();
        ...
        private void Mangers_Jan_Load(object sender, EventArgs e)
        {
            populate();
        }
    }
