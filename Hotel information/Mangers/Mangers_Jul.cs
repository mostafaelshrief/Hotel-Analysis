...
{
    public partial class Mangers_Jul : Form
    {
        public Mangers_Jul()
        {
            InitializeComponent();
        ...
        {
            Con.Open();
            string query1 = "select * from Manger_Jul where Name=N'" + textBox1.Text + "'";
            ...
            string query = "update Manger_Jul set commission='" + STRUpdateprice + "' where Name=N'" + textBox1.Text + "';";
        ...
        {
            Con.Open();
            string query = "select * from Manger_Jul";
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            {
                Con.Open();
                String query = "insert into Manger_Jul values(N'" + textBox1.Text + "','" + textBox2.Text + "')";
                SqlCommand cmd = new SqlCommand(query, Con);
                cmd.ExecuteNonQuery();
        ...
        private void Mangers_Jul_Load(object sender, EventArgs e)
        {
            populate();
        }
    }
