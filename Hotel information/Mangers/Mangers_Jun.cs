...
{
    public partial class Mangers_Jun : Form
    {
        public Mangers_Jun()
        {
            InitializeComponent();
        ...
        {
            Con.Open();
            string query1 = "select * from Manger_Jun where Name=N'" + textBox1.Text + "'";
            ...
            string query = "update Manger_Jun set commission='" + STRUpdateprice + "' where Name=N'" + textBox1.Text + "';";
        ...
        {
            Con.Open();
            string query = "select * from Manger_Jun";
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            {
                Con.Open();
                String query = "insert into Manger_Jun values(N'" + textBox1.Text + "','" + textBox2.Text + "')";
                SqlCommand cmd = new SqlCommand(query, Con);
                cmd.ExecuteNonQuery();
        ...
        private void Mangers_Jun_Load(object sender, EventArgs e)
        {
            populate();
        }
    }
