...
{
    public partial class Mangers_Mar : Form
    {
        public Mangers_Mar()
        {
            InitializeComponent();
        ...
        {
            Con.Open();
            string query1 = "select * from Manger_Mar where Name=N'" + textBox1.Text + "'";
            ...
            string query = "update Manger_Mar set commission='" + STRUpdateprice + "' where Name=N'" + textBox1.Text + "';";
        ...
        {
            Con.Open();
            string query = "select * from Manger_Mar";
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            {
                Con.Open();
                String query = "insert into Manger_Mar values(N'" + textBox1.Text + "','" + textBox2.Text + "')";
                SqlCommand cmd = new SqlCommand(query, Con);
                cmd.ExecuteNonQuery();
        ...
        private void Mangers_Mar_Load(object sender, EventArgs e)
        {
            populate();
        }
    }
