...
{
    public partial class Mangers_May : Form
    {
        public Mangers_May()
        {
            InitializeComponent();
        ...
        {
            Con.Open();
            string query1 = "select * from Manger_May where Name=N'" + textBox1.Text + "'";
            ...
            string query = "update Manger_May set commission='" + STRUpdateprice + "' where Name=N'" + textBox1.Text + "';";
        ...
        {
            Con.Open();
            string query = "select * from Manger_May";
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            {
                Con.Open();
                String query = "insert into Manger_May values(N'" + textBox1.Text + "','" + textBox2.Text + "')";
                SqlCommand cmd = new SqlCommand(query, Con);
                cmd.ExecuteNonQuery();
        ...
        private void Mangers_May_Load(object sender, EventArgs e)
        {
            populate();
        }
    }
