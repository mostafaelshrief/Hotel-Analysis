...
{
    public partial class Mangers_Oct : Form
    {
        public Mangers_Oct()
        {
            InitializeComponent();
        ...
        {
            Con.Open();
            string query1 = "select * from Manger_Oct where Name=N'" + textBox1.Text + "'";
            ...
            string query = "update Manger_Oct set commission='" + STRUpdateprice + "' where Name=N'" + textBox1.Text + "';";
        ...
        {
            Con.Open();
            string query = "select * from Manger_Oct";
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            {
                Con.Open();
                String query = "insert into Manger_Oct values(N'" + textBox1.Text + "','" + textBox2.Text + "')";
                SqlCommand cmd = new SqlCommand(query, Con);
                cmd.ExecuteNonQuery();
        ...
        private void Mangers_Oct_Load(object sender, EventArgs e)
        {
            populate();
        }
    }
