...
{
    public partial class Mangers_Sep : Form
    {
        public Mangers_Sep()
        {
            InitializeComponent();
        ...
        {
            Con.Open();
            string query1 = "select * from Manger_Sep where Name=N'" + textBox1.Text + "'";
            ...
            string query = "update Manger_Sep set commission='" + STRUpdateprice + "' where Name=N'" + textBox1.Text + "';";
        ...
        {
            Con.Open();
            string query = "select * from Manger_Sep";
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            {
                Con.Open();
                String query = "insert into Manger_Sep values(N'" + textBox1.Text + "','" + textBox2.Text + "')";
                SqlCommand cmd = new SqlCommand(query, Con);
                cmd.ExecuteNonQuery();
        ...
        private void Mangers_Sep_Load(object sender, EventArgs e)
        {
            populate();
        }
    }
