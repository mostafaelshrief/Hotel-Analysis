...
{
    public partial class Analysis_AprR : Form
    {
        public Analysis_AprR()
        {
            InitializeComponent();
        }

        private void Analysis_AprR_Load(object sender, EventArgs e)
        {
            Populate();
        }
        ...
        private void Populate()
        {
            ...
            Con.Open();
            string query = "select * from Analysis_AprTblR";
