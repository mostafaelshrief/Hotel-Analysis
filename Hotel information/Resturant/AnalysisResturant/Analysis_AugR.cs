...
{
    public partial class Analysis_AugR : Form
    {
        public Analysis_AugR()
        {
            InitializeComponent();
        }

        private void Analysis_AugR_Load(object sender, EventArgs e)
        {
            Populate();
        }
        ...
        private void Populate()
        {
            ...
            Con.Open();
            string query = "select * from Analysis_AugTblR";
