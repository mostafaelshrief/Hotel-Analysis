...
{
    public partial class Analysis_DecR : Form
    {
        public Analysis_DecR()
        {
            InitializeComponent();
        }

        private void Analysis_DecR_Load(object sender, EventArgs e)
        {
            Populate();
        }
        ...
        private void Populate()
        {
            ...
            Con.Open();
            string query = "select * from Analysis_DecTblR";
