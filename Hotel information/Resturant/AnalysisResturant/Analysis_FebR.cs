...
{
    public partial class Analysis_FebR : Form
    {
        public Analysis_FebR()
        {
            InitializeComponent();
        }

        private void Analysis_FebR_Load(object sender, EventArgs e)
        {
            Populate();
        }
        ...
        private void Populate()
        {
            ...
            Con.Open();
            string query = "select * from Analysis_FebTblR";
