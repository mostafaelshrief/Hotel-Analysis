...
{
    public partial class Analysis_JanR : Form
    {
        public Analysis_JanR()
        {
            InitializeComponent();
        }

        private void Analysis_JanR_Load(object sender, EventArgs e)
        {
            Populate();
        }
        ...
        private void Populate()
        {
            ...
            Con.Open();
            string query = "select * from Analysis_JanTblR";
