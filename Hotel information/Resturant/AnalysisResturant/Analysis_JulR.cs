...
{
    public partial class Analysis_JulR : Form
    {
        public Analysis_JulR()
        {
            InitializeComponent();
        }

        private void Analysis_JulR_Load(object sender, EventArgs e)
        {
            Populate();
        }
        ...
        private void Populate()
        {
            ...
            Con.Open();
            string query = "select * from Analysis_JulTblR";
