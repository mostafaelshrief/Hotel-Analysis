...
{
    public partial class Analysis_JunR : Form
    {
        public Analysis_JunR()
        {
            InitializeComponent();
        }

        private void Analysis_JunR_Load(object sender, EventArgs e)
        {
            Populate();
        }
        ...
        private void Populate()
        {
            ...
            Con.Open();
            string query = "select * from Analysis_JunTblR";
