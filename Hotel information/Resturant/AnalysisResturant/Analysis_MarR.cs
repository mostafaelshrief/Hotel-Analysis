...
{
    public partial class Analysis_MarR : Form
    {
        public Analysis_MarR()
        {
            InitializeComponent();
        }

        private void Analysis_MarR_Load(object sender, EventArgs e)
        {
            Populate();
        }
        ...
        private void Populate()
        {
            ...
            Con.Open();
            string query = "select * from Analysis_MarTblR";
