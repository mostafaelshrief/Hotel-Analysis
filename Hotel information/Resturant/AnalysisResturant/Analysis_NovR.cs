...
{
    public partial class Analysis_NovR : Form
    {
        public Analysis_NovR()
        {
            InitializeComponent();
        }

        private void Analysis_NovR_Load(object sender, EventArgs e)
        {
            Populate();
        }
        ...
        private void Populate()
        {
            ...
            Con.Open();
            string query = "select * from Analysis_NovTblR";
