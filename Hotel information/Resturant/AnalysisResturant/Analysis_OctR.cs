...
{
    public partial class Analysis_OctR : Form
    {
        public Analysis_OctR()
        {
            InitializeComponent();
        }

        private void Analysis_OctR_Load(object sender, EventArgs e)
        {
            Populate();
        }
        ...
        private void Populate()
        {
            ...
            Con.Open();
            string query = "select * from Analysis_OctTblR";
