...
{
    public partial class Summary_Resturant : Form
    {
        public Summary_Resturant()
        {
            InitializeComponent();
        }

        private void Summary_Resturant_Load(object sender, EventArgs e)
        {
            Populate();
        }
        ...
        private void Populate()
        {
            ...
            Con.Open();
            string query = "select * from Analysis_TotTblR";
