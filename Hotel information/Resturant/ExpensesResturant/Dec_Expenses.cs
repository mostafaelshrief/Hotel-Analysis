...
{
    public partial class Dec_Expenses : Form
    {
        public Dec_Expenses()
        {
            InitializeComponent();
        ...
        private void Dec_Expenses_Load(object sender, EventArgs e)
        {
            populate();
        }
        ...
        {
            Con.Open();
            String query = "select * from Expenses_ResturantDecTbl";
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            {
                Con.Open();
                SqlCommand cmd = new SqlCommand("INSERT INTO Expenses_ResturantDecTbl (Expenses,Price,Comment) VALUES " +
        ...
        {
            Con.Open();
            string query1 = "select * from Expenses_ResturantDecTbl where Expenses='" + comboBox1.SelectedItem.ToString() + "' ";
            ...
            string query = "update Expenses_ResturantDecTbl set Price='" + STRUpdateprice + "',Comment='" + textBox2.Text + "' where  Expenses='" + comboBox1.SelectedItem.ToString() + "';";
        ...
        private void button3_Click(object sender, EventArgs e)
        {
            ...
            {
                Con.Open();
                String query = "delete from Expenses_ResturantDecTbl where Expenses=N'" + comboBox1.SelectedItem.ToString() + "';";
                SqlCommand cmd = new SqlCommand(query, Con);
                cmd.ExecuteNonQuery();
        ...
        private void button4_Click(object sender, EventArgs e)
        {
            ...
            string query = "update Analysis_DecTblR set Total='" + label7.Text + "' where  Name='" + label1.Text + "';";
            SqlCommand cmd = new SqlCommand(query, Con);
            cmd.ExecuteNonQuery();
            Con.Close();
        }
