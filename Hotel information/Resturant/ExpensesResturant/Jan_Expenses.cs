...
{
    public partial class Jan_Expenses : Form
    {
        public Jan_Expenses()
        {
            InitializeComponent();
        ...
        private void Jan_Expenses_Load(object sender, EventArgs e)
        {
            populate();
        }
        ...
        {
            Con.Open();
            String query = "select * from Expenses_ResturantJanTbl";
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            {
                Con.Open();
                SqlCommand cmd = new SqlCommand("INSERT INTO Expenses_ResturantJanTbl (Expenses,Price,Comment) VALUES " +
        ...
        {
            Con.Open();
            string query1 = "select * from Expenses_ResturantJanTbl where Expenses='" + comboBox1.SelectedItem.ToString() + "' ";
            ...
            string query = "update Expenses_ResturantJanTbl set Price='" + STRUpdateprice + "',Comment='" + textBox2.Text + "' where  Expenses='" + comboBox1.SelectedItem.ToString() + "';";
        ...
        private void button3_Click(object sender, EventArgs e)
        {
            ...
            {
                Con.Open();
                String query = "delete from Expenses_ResturantJanTbl where Expenses=N'" + comboBox1.SelectedItem.ToString() + "';";
                SqlCommand cmd = new SqlCommand(query, Con);
                cmd.ExecuteNonQuery();
        ...
        private void button4_Click(object sender, EventArgs e)
        {
            ...
            string query = "update Analysis_JanTblR set Total='" + label7.Text + "' where  Name='" + label1.Text + "';";
            SqlCommand cmd = new SqlCommand(query, Con);
            cmd.ExecuteNonQuery();
            Con.Close();
        }
