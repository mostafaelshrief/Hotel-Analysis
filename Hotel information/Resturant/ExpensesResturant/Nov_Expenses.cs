...
{
    public partial class Nov_Expenses : Form
    {
        public Nov_Expenses()
        {
            InitializeComponent();
        ...
        private void Nov_Expenses_Load(object sender, EventArgs e)
        {
            populate();
        }
        ...
        {
            Con.Open();
            String query = "select * from Expenses_ResturantNovTbl";
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            {
                Con.Open();
                SqlCommand cmd = new SqlCommand("INSERT INTO Expenses_ResturantNovTbl (Expenses,Price,Comment) VALUES " +
        ...
        {
            Con.Open();
            string query1 = "select * from Expenses_ResturantNovTbl where Expenses='" + comboBox1.SelectedItem.ToString() + "' ";
            ...
            string query = "update Expenses_ResturantNovTbl set Price='" + STRUpdateprice + "',Comment='" + textBox2.Text + "' where  Expenses='" + comboBox1.SelectedItem.ToString() + "';";
        ...
        private void button3_Click(object sender, EventArgs e)
        {
            ...
            {
                Con.Open();
                String query = "delete from Expenses_ResturantNovTbl where Expenses=N'" + comboBox1.SelectedItem.ToString() + "';";
                SqlCommand cmd = new SqlCommand(query, Con);
                cmd.ExecuteNonQuery();
        ...
        private void button4_Click(object sender, EventArgs e)
        {
            ...
            string query = "update Analysis_NovTblR set Total='" + label7.Text + "' where  Name='" + label1.Text + "';";
            SqlCommand cmd = new SqlCommand(query, Con);
            cmd.ExecuteNonQuery();
            Con.Close();
        }
