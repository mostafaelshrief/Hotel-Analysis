...
{
    public partial class Resturant_Expenses_Summary : Form
    {
        public Resturant_Expenses_Summary()
        {
            InitializeComponent();
        }
        ...
        {
            Restureanr_Report_Expenses restureanr_Report_Expenses = new Restureanr_Report_Expenses();
            restureanr_Report_Expenses.Show();
            this.Hide();
        }
        ...
        private void RefreshBtn_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                try
                {
                    ...
                    Con.Open();
                    string query = "select * from Expenses_ResturantJanTbl where Expenses='" + BillSelectedlist.SelectedItem.ToString() + "'  ";
                    SqlCommand cmd = new SqlCommand(query, Con);
                    SqlDataAdapter sda = new SqlDataAdapter(cmd);
                    sda.SelectCommand = cmd;
                    DataTable dt = new DataTable();
                    sda.Fill(dt);
                    string query1 = "select * from Expenses_ResturantFebTbl where Expenses='" + BillSelectedlist.SelectedItem.ToString() + "'  ";
                    SqlCommand cmd1 = new SqlCommand(query1, Con);
                    SqlDataAdapter sda1 = new SqlDataAdapter(cmd1);
                    sda1.SelectCommand = cmd1;
                    DataTable dt1 = new DataTable();
                    sda1.Fill(dt1);
                    string query2 = "select * from Expenses_ResturantMarTbl where Expenses='" + BillSelectedlist.SelectedItem.ToString() + "'  ";
                    SqlCommand cmd2 = new SqlCommand(query2, Con);
                    SqlDataAdapter sda2 = new SqlDataAdapter(cmd2);
                    sda2.SelectCommand = cmd2;
                    DataTable dt2 = new DataTable();
                    sda2.Fill(dt2);
                    string query3 = "select * from Expenses_ResturantAprTbl where Expenses='" + BillSelectedlist.SelectedItem.ToString() + "'  ";
                    SqlCommand cmd3 = new SqlCommand(query3, Con);
                    SqlDataAdapter sda3 = new SqlDataAdapter(cmd3);
                    sda3.SelectCommand = cmd3;
                    DataTable dt3 = new DataTable();
                    sda3.Fill(dt3);
                    string query4 = "select * from Expenses_ResturantMayTbl where Expenses='" + BillSelectedlist.SelectedItem.ToString() + "'  ";
                    SqlCommand cmd4 = new SqlCommand(query4, Con);
                    SqlDataAdapter sda4 = new SqlDataAdapter(cmd4);
                    sda4.SelectCommand = cmd4;
                    DataTable dt4 = new DataTable();
                    sda4.Fill(dt4);
                    string query5 = "select * from Expenses_ResturantJunTbl where Expenses='" + BillSelectedlist.SelectedItem.ToString() + "'  ";
                    SqlCommand cmd5 = new SqlCommand(query5, Con);
                    SqlDataAdapter sda5 = new SqlDataAdapter(cmd5);
                    sda5.SelectCommand = cmd5;
                    DataTable dt5 = new DataTable();
                    sda5.Fill(dt5);
                    string query6 = "select * from Expenses_ResturantJulTbl where Expenses='" + BillSelectedlist.SelectedItem.ToString() + "'  ";
                    SqlCommand cmd6 = new SqlCommand(query6, Con);
                    SqlDataAdapter sda6 = new SqlDataAdapter(cmd6);
                    sda6.SelectCommand = cmd6;
                    DataTable dt6 = new DataTable();
                    sda6.Fill(dt6);
                    string query7 = "select * from Expenses_ResturantAugTbl where Expenses='" + BillSelectedlist.SelectedItem.ToString() + "'  ";
                    SqlCommand cmd7 = new SqlCommand(query7, Con);
                    SqlDataAdapter sda7 = new SqlDataAdapter(cmd7);
                    sda7.SelectCommand = cmd7;
                    DataTable dt7 = new DataTable();
                    sda7.Fill(dt7);
                    string query8 = "select * from Expenses_ResturantSepTbl where Expenses='" + BillSelectedlist.SelectedItem.ToString() + "'  ";
                    SqlCommand cmd8 = new SqlCommand(query8, Con);
                    SqlDataAdapter sda8 = new SqlDataAdapter(cmd8);
                    sda8.SelectCommand = cmd8;
                    DataTable dt8 = new DataTable();
                    sda8.Fill(dt8);
                    string query9 = "select * from Expenses_ResturantOctTbl where Expenses='" + BillSelectedlist.SelectedItem.ToString() + "'  ";
                    SqlCommand cmd9 = new SqlCommand(query9, Con);
                    SqlDataAdapter sda9 = new SqlDataAdapter(cmd9);
                    sda9.SelectCommand = cmd9;
                    DataTable dt9 = new DataTable();
                    sda9.Fill(dt9);
                    string query10 = "select * from Expenses_ResturantNovTbl where Expenses='" + BillSelectedlist.SelectedItem.ToString() + "'  ";
                    SqlCommand cmd10 = new SqlCommand(query10, Con);
                    SqlDataAdapter sda10 = new SqlDataAdapter(cmd10);
                    sda10.SelectCommand = cmd10;
                    DataTable dt10 = new DataTable();
                    sda10.Fill(dt10);
                    string query11 = "select * from Expenses_ResturantDecTbl where Expenses='" + BillSelectedlist.SelectedItem.ToString() + "'  ";
