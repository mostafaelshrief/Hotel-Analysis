...
{
    public partial class Apr_Income : Form
    {
        public Apr_Income()
        {
            InitializeComponent();
        ...
        {
            Con.Open();
            string query = "Select * from Resturant_AprTbl";
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            { 
            Con.Open();
            SqlCommand sql = new SqlCommand("Insert Into Resturant_AprTbl (Income,Price,Comment) Values" +"(@Income,@Price,@Comment)",Con);
        ...
        {
            Con.Open();
            string query = "select * from Resturant_AprTbl Where Income='"+comboBox1.SelectedItem.ToString()+"'";
            ...
            string query1 = "update Resturant_AprTbl set Price='" + UPdatePriceINT + "',Comment='"+textBox2.Text+"'";
        ...
        private void button3_Click(object sender, EventArgs e)
        {
            try { 
            Con.Open();
            string query = "delete from Resturant_AprTbl where Income='" + comboBox1.SelectedItem.ToString()+"'";
