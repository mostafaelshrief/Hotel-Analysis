...
{
    public partial class Aug_Income : Form
    {
        public Aug_Income()
        {
            InitializeComponent();
        ...
        {
            Con.Open();
            string query = "Select * from Resturant_AugTbl";
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            {
                Con.Open();
                SqlCommand sql = new SqlCommand("Insert Into Resturant_AugTbl (Income,Price,Comment) Values" + "(@Income,@Price,@Comment)", Con);
        ...
        {
            Con.Open();
            string query = "select * from Resturant_AugTbl Where Income='" + comboBox1.SelectedItem.ToString() + "'";
            ...
            string query1 = "update Resturant_AugTbl set Price='" + UPdatePriceINT + "',Comment='" + textBox2.Text + "'";
        ...
        private void button3_Click(object sender, EventArgs e)
        {
            ...
            {
                Con.Open();
                string query = "delete from Resturant_AugTbl where Income='" + comboBox1.SelectedItem.ToString() + "'";
        ...
        private void Aug_Income_Load(object sender, EventArgs e)
        {
            populate();
        }
