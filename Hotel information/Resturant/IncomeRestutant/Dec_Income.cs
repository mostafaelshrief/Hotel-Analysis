...
{
    public partial class Dec_Income : Form
    {
        public Dec_Income()
        {
            InitializeComponent();
        ...
        {
            Con.Open();
            string query = "Select * from Resturant_DecTbl";
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            {
                Con.Open();
                SqlCommand sql = new SqlCommand("Insert Into Resturant_DecTbl (Income,Price,Comment) Values" + "(@Income,@Price,@Comment)", Con);
        ...
        {
            Con.Open();
            string query = "select * from Resturant_DecTbl Where Income='" + comboBox1.SelectedItem.ToString() + "'";
            ...
            string query1 = "update Resturant_DecTbl set Price='" + UPdatePriceINT + "',Comment='" + textBox2.Text + "'";
        ...
        private void button3_Click(object sender, EventArgs e)
        {
            ...
            {
                Con.Open();
                string query = "delete from Resturant_DecTbl where Income='" + comboBox1.SelectedItem.ToString() + "'";
        ...
        private void Dec_Income_Load(object sender, EventArgs e)
        {
            populate();
        }
