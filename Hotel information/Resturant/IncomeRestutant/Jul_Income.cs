...
{
    public partial class Jul_Income : Form
    {
        public Jul_Income()
        {
            InitializeComponent();
        ...
        {
            Con.Open();
            string query = "Select * from Resturant_JulTbl";
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            {
                Con.Open();
                SqlCommand sql = new SqlCommand("Insert Into Resturant_JulTbl (Income,Price,Comment) Values" + "(@Income,@Price,@Comment)", Con);
        ...
        {
            Con.Open();
            string query = "select * from Resturant_JulTbl Where Income='" + comboBox1.SelectedItem.ToString() + "'";
            ...
            string query1 = "update Resturant_JulTbl set Price='" + UPdatePriceINT + "',Comment='" + textBox2.Text + "'";
        ...
        private void button3_Click(object sender, EventArgs e)
        {
            ...
            {
                Con.Open();
                string query = "delete from Resturant_JulTbl where Income='" + comboBox1.SelectedItem.ToString() + "'";
        ...
        private void Jul_Income_Load(object sender, EventArgs e)
        {
            populate();
        }
