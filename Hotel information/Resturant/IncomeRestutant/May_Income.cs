...
{
    public partial class May_Income : Form
    {
        public May_Income()
        {
            InitializeComponent();
        ...
        {
            Con.Open();
            string query = "Select * from Resturant_MayTbl";
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            {
                Con.Open();
                SqlCommand sql = new SqlCommand("Insert Into Resturant_MayTbl (Income,Price,Comment) Values" + "(@Income,@Price,@Comment)", Con);
        ...
        {
            Con.Open();
            string query = "select * from Resturant_MayTbl Where Income='" + comboBox1.SelectedItem.ToString() + "'";
            ...
            string query1 = "update Resturant_MayTbl set Price='" + UPdatePriceINT + "',Comment='" + textBox2.Text + "'";
        ...
        private void button3_Click(object sender, EventArgs e)
        {
            ...
            {
                Con.Open();
                string query = "delete from Resturant_MayTbl where Income='" + comboBox1.SelectedItem.ToString() + "'";
        ...
        private void May_Income_Load(object sender, EventArgs e)
        {
            populate();
        }
        int STRUpdateprice;
