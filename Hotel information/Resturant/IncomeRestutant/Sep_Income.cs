...
{
    public partial class Sep_Income : Form
    {
        public Sep_Income()
        {
            InitializeComponent();
        ...
        {
            Con.Open();
            string query = "Select * from Resturant_SepTbl";
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            {
                Con.Open();
                SqlCommand sql = new SqlCommand("Insert Into Resturant_SepTbl (Income,Price,Comment) Values" + "(@Income,@Price,@Comment)", Con);
        ...
        {
            Con.Open();
            string query = "select * from Resturant_SepTbl Where Income='" + comboBox1.SelectedItem.ToString() + "'";
            ...
            string query1 = "update Resturant_SepTbl set Price='" + UPdatePriceINT + "',Comment='" + textBox2.Text + "'";
        ...
        private void button3_Click(object sender, EventArgs e)
        {
            ...
            {
                Con.Open();
                string query = "delete from Resturant_SepTbl where Income='" + comboBox1.SelectedItem.ToString() + "'";
        ...
        private void Sep_Income_Load(object sender, EventArgs e)
        {
            populate();
        }
